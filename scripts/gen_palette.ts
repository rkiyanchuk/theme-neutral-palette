...
const definitions = {
  latte: {
    ...
    colors: {
      ...
      text: {
        name: "Text",
        object: new Color("oklch", [0.435470, 0.043008, 259.325021]),
        accent: false,
      },
      subtext1: {
        name: "Subtext 1",
        object: new Color("oklch", [0.492003, 0.038491, 259.299161]),
        accent: false,
      },
      subtext0: {
        name: "Subtext 0",
        object: new Color("oklch", [0.547078, 0.034343, 259.083697]),
        accent: false,
      },
      overlay2: {
        name: "Overlay 2",
        object: new Color("oklch", [0.600878, 0.030490, 258.694364]),
        accent: false,
      },
      overlay1: {
        name: "Overlay 1",
        object: new Color("oklch", [0.653554, 0.026879, 258.120816]),
        accent: false,
      },
      overlay0: {
        name: "Overlay 0",
        object: new Color("oklch", [0.707668, 0.023670, 254.600835]),
        accent: false,
      },
      surface2: {
        name: "Surface 2",
        object: new Color("oklch", [0.758394, 0.020453, 253.153552]),
        accent: false,
      },
      surface1: {
        name: "Surface 1",
        object: new Color("oklch", [0.808307, 0.017393, 251.198155]),
        accent: false,
      },
      surface0: {
        name: "Surface 0",
        object: new Color("oklch", [0.857477, 0.014480, 248.475592]),
        accent: false,
      },
      base: {
        name: "Base",
        object: new Color("oklch", [0.957761, 0.005767, 244.532152]),
        accent: false,
      },
      mantle: {
        name: "Mantle",
        object: new Color("oklch", [0.933459, 0.008714, 244.520602]),
        accent: false,
      },
      crust: {
        name: "Crust",
        object: new Color("oklch", [0.905965, 0.011717, 244.507105]),
        accent: false,
      },
    },
  },
  frappe: {
    ...
    colors: {
      ...
      text: {
        name: "Text",
        object: new Color("oklch", [0.861916, 0.052553, 253.347361]),
        accent: false,
      },
      subtext1: {
        name: "Subtext 1",
        object: new Color("oklch", [0.808435, 0.050670, 252.677975]),
        accent: false,
      },
      subtext0: {
        name: "Subtext 0",
        object: new Color("oklch", [0.752384, 0.048283, 254.472593]),
        accent: false,
      },
      overlay2: {
        name: "Overlay 2",
        object: new Color("oklch", [0.696974, 0.046370, 253.776912]),
        accent: false,
      },
      overlay1: {
        name: "Overlay 1",
        object: new Color("oklch", [0.640055, 0.043000, 252.613701]),
        accent: false,
      },
      overlay0: {
        name: "Overlay 0",
        object: new Color("oklch", [0.580854, 0.042052, 255.198183]),
        accent: false,
      },
      surface2: {
        name: "Surface 2",
        object: new Color("oklch", [0.521117, 0.038590, 253.999202]),
        accent: false,
      },
      surface1: {
        name: "Surface 1",
        object: new Color("oklch", [0.460057, 0.036661, 252.965799]),
        accent: false,
      },
      surface0: {
        name: "Surface 0",
        object: new Color("oklch", [0.394919, 0.034239, 255.899927]),
        accent: false,
      },
      base: {
        name: "Base",
        object: new Color("oklch", [0.329074, 0.032391, 254.758046]),
        accent: false,
      },
      mantle: {
        name: "Mantle",
        object: new Color("oklch", [0.297342, 0.029378, 256.214395]),
        accent: false,
      },
      crust: {
        name: "Crust",
        object: new Color("oklch", [0.272002, 0.026387, 255.115405]),
        accent: false,
      },
    },
  },
  macchiato: {
    ...
    colors: {
      ...
      text: {
        name: "Text",
        object: new Color("oklch", [0.870825, 0.048078, 253.665091]),
        accent: false,
      },
      subtext1: {
        name: "Subtext 1",
        object: new Color("oklch", [0.811977, 0.045942, 254.267185]),
        accent: false,
      },
      subtext0: {
        name: "Subtext 0",
        object: new Color("oklch", [0.751281, 0.044056, 253.532655]),
        accent: false,
      },
      overlay2: {
        name: "Overlay 2",
        object: new Color("oklch", [0.690488, 0.043335, 254.538771]),
        accent: false,
      },
      overlay1: {
        name: "Overlay 1",
        object: new Color("oklch", [0.627154, 0.041473, 253.732825]),
        accent: false,
      },
      overlay0: {
        name: "Overlay 0",
        object: new Color("oklch", [0.560792, 0.040672, 256.474753]),
        accent: false,
      },
      surface2: {
        name: "Surface 2",
        object: new Color("oklch", [0.493852, 0.038872, 255.683316]),
        accent: false,
      },
      surface1: {
        name: "Surface 1",
        object: new Color("oklch", [0.425904, 0.038509, 256.947676]),
        accent: false,
      },
      surface0: {
        name: "Surface 0",
        object: new Color("oklch", [0.353790, 0.036947, 255.985096]),
        accent: false,
      },
      base: {
        name: "Base",
        object: new Color("oklch", [0.278808, 0.035341, 256.936815]),
        accent: false,
      },
      mantle: {
        name: "Mantle",
        object: new Color("oklch", [0.249251, 0.030481, 258.435034]),
        accent: false,
      },
      crust: {
        name: "Crust",
        object: new Color("oklch", [0.218806, 0.025457, 260.657237]),
        accent: false,
      },
    },
  },
  mocha: {
    ...
    colors: {
      ...
      text: {
        name: "Text",
        object: new Color("oklch", [0.878660, 0.042552, 252.276738]),
        accent: false,
      },
      subtext1: {
        name: "Subtext 1",
        object: new Color("oklch", [0.816823, 0.040345, 252.862189]),
        accent: false,
      },
      subtext0: {
        name: "Subtext 0",
        object: new Color("oklch", [0.750961, 0.039565, 253.931990]),
        accent: false,
      },
      overlay2: {
        name: "Overlay 2",
        object: new Color("oklch", [0.686521, 0.037355, 254.725277]),
        accent: false,
      },
      overlay1: {
        name: "Overlay 1",
        object: new Color("oklch", [0.617567, 0.036670, 256.004708]),
        accent: false,
      },
      overlay0: {
        name: "Overlay 0",
        object: new Color("oklch", [0.549691, 0.034494, 257.095075]),
        accent: false,
      },
      surface2: {
        name: "Surface 2",
        object: new Color("oklch", [0.476506, 0.033994, 258.643040]),
        accent: false,
      },
      surface1: {
        name: "Surface 1",
        object: new Color("oklch", [0.403691, 0.031955, 260.152004]),
        accent: false,
      },
      surface0: {
        name: "Surface 0",
        object: new Color("oklch", [0.324022, 0.031885, 261.978442]),
        accent: false,
      },
      base: {
        name: "Base",
        object: new Color("oklch", [0.242867, 0.030357, 263.910970]),
        accent: false,
      },
      mantle: {
        name: "Mantle",
        object: new Color("oklch", [0.215522, 0.025417, 264.064699]),
        accent: false,
      },
      crust: {
        name: "Crust",
        object: new Color("oklch", [0.182782, 0.020375, 264.203848]),
        accent: false,
      },
    },
  },

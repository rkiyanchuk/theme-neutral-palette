...
const definitions = {
  ...
  macchiato: {
    ...
    colors: {
      ...
      text: {
        name: "Text",
        object: new Color("oklch", [0.873250, 0.024941, 248.088043]),
        accent: false,
      },
      subtext1: {
        name: "Subtext 1",
        object: new Color("oklch", [0.815500, 0.024439, 248.841304]),
        accent: false,
      },
      subtext0: {
        name: "Subtext 0",
        object: new Color("oklch", [0.755000, 0.023913, 249.630435]),
        accent: false,
      },
      overlay2: {
        name: "Overlay 2",
        object: new Color("oklch", [0.694500, 0.023387, 250.419565]),
        accent: false,
      },
      overlay1: {
        name: "Overlay 1",
        object: new Color("oklch", [0.631250, 0.022837, 251.244565]),
        accent: false,
      },
      overlay0: {
        name: "Overlay 0",
        object: new Color("oklch", [0.568500, 0.022291, 252.063043]),
        accent: false,
      },
      surface2: {
        name: "Surface 2",
        object: new Color("oklch", [0.500250, 0.021698, 252.953261]),
        accent: false,
      },
      surface1: {
        name: "Surface 1",
        object: new Color("oklch", [0.434750, 0.021128, 253.807609]),
        accent: false,
      },
      surface0: {
        name: "Surface 0",
        object: new Color("oklch", [0.361500, 0.020491, 254.763043]),
        accent: false,
      },
      base: {
        name: "Base",
        object: new Color("oklch", [0.288250, 0.019854, 255.718478]),
        accent: false,
      },
      mantle: {
        name: "Mantle",
        object: new Color("oklch", [0.261000, 0.019617, 256.073913]),
        accent: false,
      },
      crust: {
        name: "Crust",
        object: new Color("oklch", [0.230500, 0.019352, 256.471739]),
        accent: false,
      },
    },
  },
